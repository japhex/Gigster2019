...
import { GigContainer, GigStyled, Ticket, TicketLeft, TicketBottom, Title, Details, PopularityContainer, Popularity } from '../styles/gigStyled'
...
const Gig = ({gig, type}) => {
	...
	return (
		<Card titleContent={
			<>
				<Artist id={id} activeRating={rating} artist={artist} type={type} festival={festival} />
